...
CREATE TABLE `groupfightstats` (
  ...
  CONSTRAINT `id_hero_fk` FOREIGN KEY (`id_hero`) REFERENCES `hero` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `id_killer_fk` FOREIGN KEY (`id_hero`) REFERENCES `hero` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
